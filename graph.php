...
<html lang="en">
    ...
    <h2>Water quality data for $year at $mysite</h2>
		<main>
      <div id="content">
        <p>Some text goes here. And we can explain a whole bunch of things here so that we can take up the whole screen, you know so that it will make the map bigger.</p>
